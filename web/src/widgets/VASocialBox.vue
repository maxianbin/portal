<template>
  <!-- Box Comment -->
    <div class="box box-widget">
      ...
      <!-- /.box-header -->
      <div class="box-body">
        <img v-for="(image,index) in images" class="img-responsive pad" :src="image" :key="index" alt="Photo">

        <p>{{ text }}</p>

        <!-- Attachment -->
        <div class="attachment-block clearfix" v-for="(attachment,index) in attachments">
          <img class="attachment-img" :src="attachment.image" :key="index" alt="Attachment Image">
      ...
      <div class="box-footer box-comments">
        <va-social-box-comment v-for="(comment,index) in comments"
          :name="comment.name"
